...
public class GalleryActivity extends AppCompatActivity implements
        ScrollView.ScrollListener<GalleryAdapter.ViewHolder>,
        ScrollView.OnItemChangedListener<GalleryAdapter.ViewHolder>,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ScrollView itemPicker = (ScrollView) findViewById(R.id.item_picker);
