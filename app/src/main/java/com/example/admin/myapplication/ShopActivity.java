...
public class ShopActivity extends AppCompatActivity implements ScrollView.OnItemChangedListener,
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        shop = Shop.get();
        data = shop.getData();
        itemPicker = (ScrollView) findViewById(R.id.item_picker);
        itemPicker.setOrientation(DSVOrientation.HORIZONTAL);
        itemPicker.addOnItemChangedListener(this);
        infiniteAdapter = InfiniteScrollAdapter.wrap(new ShopAdapter(data));
        itemPicker.setAdapter(infiniteAdapter);
        itemPicker.setItemTransitionTimeMillis(ScrollView.getTransitionTime());
    ...
    public void onClick(View v) {
        switch (v.getId()) {
            ...
            case R.id.btn_transition_time:
                ScrollView.configureTransitionTime(itemPicker);
                break;
            case R.id.btn_smooth_scroll:
                ScrollView.smoothScrollToUserSelectedPosition(itemPicker, v);
                break;
            default:
